// Understanding logic of flappy bird from: https://www.youtube.com/watch?v=cXgA1d_E-jY&t=3s
$(function () {
    ...
    var beginGame = setInterval(function() {
        ...
        if ( collisionDetector(superman, columnOne) || collisionDetector(superman, columnTwo) || parseInt(superman.css('top')) > containerHeight - supermanHeight)
            {
        ...
        // Update score by 1 everytime superman flies past columns and columns disappear
        ...
        if(columnCurrent > containerWidth ) {
            // Randomize column heights top and bottom
            var changeHeightOne = parseInt(Math.random() * 200); 
            var changeHeightTwo = parseInt(Math.random() * 120);
            // Manipulate height of first column
            columnOne.css('height', columnCurrentPosition + changeHeightOne);
            // Manipulate height of second column
            columnTwo.css('height', columnCurrentPosition - changeHeightTwo);
